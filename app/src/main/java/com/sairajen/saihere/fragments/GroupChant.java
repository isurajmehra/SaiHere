...
import com.sairajen.saihere.activity.SimplePostDetails;
import com.sairajen.saihere.adapter.AdapterPostList;
 ...
 * @author Gmonetix
 */
public class GroupChant extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_group_chant, container, false);

        for (int i = 0; i< Home.categoryList.size(); i++){
            if (Home.categoryList.get(i).id == Const.CATEGORY_GROUP_CHANT) {
        ...
        mAdapter.setOnItemClickListener(new AdapterPostList.OnItemClickListener() {
            ...
            public void onItemClick(View v, Post obj, int position) {
                SimplePostDetails.navigate((AppCompatActivity) getActivity(), v.findViewById(R.id.image), obj);
            }
        });
