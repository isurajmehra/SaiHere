 ...
 * @author Gmonetix
 */
public class Miracles extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_miracles, container, false);

        for (int i = 0; i< Home.categoryList.size(); i++){
            if (Home.categoryList.get(i).id == Const.CATEGORY_MIRACLES_OF_SAI) {
